              ...
              <div onClick={() => { props.handleClick(outfit.id); }}>
                ...
                <div className="product-description">
                  <div className="overview-relProd">
                    ...
                    {outfit.default_price}
                  </div>
                  <div className="product-ratings">
                    <div className='POStarRating' data-testid="starRating">
                      <Rating start={0} stop={5} initialRating={outfit.ratings} emptySymbol={<FontAwesomeIcon icon={['fas', 'star']} color='#808080' />} fullSymbol={<FontAwesomeIcon icon={['fas', 'star']} color='#f8ce0b' />} readonly />
                    </div>
                  </div>
                </div>
              </div>
